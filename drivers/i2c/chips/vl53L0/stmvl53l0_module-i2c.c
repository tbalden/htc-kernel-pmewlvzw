...
static int Laser_pinctrl_init(struct stmvl53l0_data *laser_data)
{
    ...
    /* Enable power_2v8/io_1v8 and pull high the power down gpio here
     * Reset them to off state when probe is finished. */
    /* Enable io 1v8*/
    ...
    /* Pull high the power_gpio to turn on power source */
    ...
    /* Pull high the laser power down gpio to turn on itself */
