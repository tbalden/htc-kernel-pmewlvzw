...
static u32 lm3627x_init_regs[] = {
	LMU_BL_REG(LM3627X_REG_CONFIG1, LM3627X_OVP_MASK, LM3627X_OVP_21V),
	LM3627X_INIT_SWFREQ_1MHZ,
	LMU_BL_REG(LM3627X_REG_CONFIG2, LM3627X_CURR_RAMP_MASK, LM3627X_CURR_RAMP_100MS),
	LMU_BL_REG(0x10, 0xff, 0x7e),
};
